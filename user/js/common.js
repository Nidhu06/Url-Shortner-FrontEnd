document.getElementById('Nimmy').addEventListener('click', () => {
...
async function checklogin() {
    let response = await fetch('https://nimmy-urlshortner.herokuapp.com/checklogin', {
        method: 'GET',
        credentials: 'include',
        headers: {
...
async function logout() {
    let response = await fetch('https://nimmy-urlshortner.herokuapp.com/logout', {
        method: 'GET',
        credentials: 'include',
        headers: {
            'Content-Type': 'application/json'
