...
async function myLinks() {
    ...
    let response = await fetch('https://nimmy-urlshortner.herokuapp.com/MyLinks', {
        method: 'POST',
        ...
        card.innerHTML = (`
            <div class="short-link row p-2 m-0 text-center">
                <div class="col-lg-6  col-sm-12">
                    ...
                    <small>
                        <a href="https://nimmy-urlshortner.herokuapp.com/fy/${link.shortLink}">
                        nimmy-urlshortner.herokuapp.com/fy/${link.shortLink}                
                        </a>
                    </small>
                </div>
                <div class="col-lg-6 col-sm-12">
